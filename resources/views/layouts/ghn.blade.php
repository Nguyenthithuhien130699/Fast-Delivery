                ...
                <div class="col-9  text-right">
                    ...
                    <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                        <ul class="site-menu main-menu js-clone-nav ml-auto ">
                            ...
                            <li><a href="" class="nav-link">Tạo đơn</a></li>
                            <li><a href="" class="nav-link">Tra cứu vận đơn</a></li>
                            @if(auth()->user())
...
{{--                    <P>Giấy CNĐKDN: 0311 907 295 do Sở Kế Hoạch và Đầu Tư TP ĐN cấp lần đầu ngày 02/08/2020, cấp thay đổi lần thứ 16 ngày 10/5/2019.</P>--}}
                </div>
                <div class="col-lg-8 ml-auto">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <p>Huynh Huu Phuc</p>
                            <P>Trụ sở chính: Cẩm Lệ - Đà Nẵng</P>
                        </div>
                        <div class="col-lg-3">
